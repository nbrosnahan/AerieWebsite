...
A Hugo blog built on the [Congo](https://github.com/jpanther/congo) theme, consumed as a Hugo Module — no npm, no build
tooling beyond Hugo itself (plus Go, which Hugo needs on `PATH` to resolve the theme module) — deployed to GitHub Pages.
